...
public final class FortifyExceptionUtil {
    ...
    public static <T> void verifyFortifyResponseCode(Response<T> response, String apiName) throws IntegrationException {
        ...
        case 201:
            ...
            break;
        default:
            logger.error("Response code::" + responseCode + ", Api::" + apiName + ", Error message::" + response.message());
            throw new IntegrationException("Response code::" + responseCode + ", Api::" + apiName + ", Error message::" + response.message());
        }
    }
}
