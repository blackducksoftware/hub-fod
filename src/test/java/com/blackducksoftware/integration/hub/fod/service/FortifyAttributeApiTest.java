...
public class FortifyAttributeApiTest extends TestCase {
    ...
    @Test
    public void getFortifyAttributes() throws IOException, IntegrationException {
        List<FortifyAttribute> attributes = blackDuckFortifyJobConfig.getFortifyAttributeApi().getRequiredFortifyAttributes(accessToken);
